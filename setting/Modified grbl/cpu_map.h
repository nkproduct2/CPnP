...
// Define extra light enable output pins.
#define BOTTOM_LIGHT_DDR    DDRH
#define BOTTOM_LIGHT_PORT   PORTH
#define BOTTOM_LIGHT_BIT    3 // MEGA2560 Digital Pin 6
#define TOP_LIGHT_DDR       DDRE
#define TOP_LIGHT_PORT      PORTE
#define TOP_LIGHT_BIT       3 // MEGA2560 Digital Pin 5
...
// Define extra feeder enable output pins.
#define FEEDER_ONE_DDR   DDRF
#define FEEDER_ONE_PORT  PORTF
#define FEEDER_ONE_BIT    0 // MEGA2560  Pin A0
#define FEEDER_TWO_DDR    DDRF
#define FEEDER_TWO_PORT   PORTF
#define FEEDER_TWO_BIT    1 // MEGA2560  Pin A1
#define FEEDER_THREE_DDR    DDRF
#define FEEDER_THREE_PORT   PORTF
#define FEEDER_THREE_BIT  2 // MEGA2560  Pin A2 
#define FEEDER_FOUR_DDR    DDRF
#define FEEDER_FOUR_PORT   PORTF
#define FEEDER_FOUR_BIT   3 // MEGA2560  Pin A3
 
//#define FEEDER_MASK ((1<<FEEDER_ONE_BIT)|(1<<FEEDER_TWO_BIT)|(<<FEEDER_THREE_BIT)|(<<FEEDER_FOUR_BIT))

// Define extra Vacuum  Value input pins.
#ifdef BOARD_REV6
#define CONTROL_ADC_BIT   0 // MEGA2560 Analog Pin A0
#else
#define CONTROL_ADC_BIT   7 // MEGA2560 Analog Pin A15(A8-A15)
#endif
