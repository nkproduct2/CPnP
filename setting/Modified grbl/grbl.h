...
#ifdef BOARD_REV6
	#define GRBL_VERSION "1.1e for CompactPnP(Rev.6)"
#else
	#define GRBL_VERSION "1.1e for CompactPnP(Rev.7)"
#endif

#define GRBL_VERSION_BUILD "2023_01_07"
...
#include "top_light_control.h"
#include "bottom_light_control.h"
