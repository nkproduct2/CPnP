...
#define BOARD_REV6 //commnet Rev.7
//#define DEFAULTS_GENERIC
#define DEFAULTS_COMPACTPNP
//#define DEFAULTS_ABC_AXIS
#define DEFAULTS_ABC_AXIS_COMPACTPNP
...
// Inverts the selected feeder pin from low-disabled/high-enabled to low-enabled/high-disabled. Useful
// for some pre-built electronic boards.
#define INVERT_FEEDER_PIN // Default disabled. Uncomment to enable.
