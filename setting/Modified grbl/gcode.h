...
#define MODAL_GROUP_M10 14 // [M15,M16,M17,M18,M19] extra feeder control
#define MODAL_GROUP_M11 15 // [M11,M12] extra top light control
#define MODAL_GROUP_M12 16 // [M13,M14] extra bottom light control
#define MODAL_GROUP_M13 17 // [M20] extra vacuum control
...
#define FEEDER_DISABLE      0 // M19 (Default: Must be zero)
#define FEEDER_ONE_CHANGE   1 // M15 (NOTE: Uses planner condition bit flag)
#define FEEDER_TWO_CHANGE   2 // M16 (NOTE: Uses planner condition bit flag)
#define FEEDER_THREE_CHANGE 3 // M17 (NOTE: Uses planner condition bit flag)
#define FEEDER_FOUR_CHANGE  4 // M18 (NOTE: Uses planner condition bit flag)

// Modal Group M11: Extra relay control
#define TOP_LIGHT_DISABLE    0 // M12 (Default: Must be zero)
#define TOP_LIGHT_ENABLE     1 // M11 (NOTE: Uses planner condition bit flag)

// Modal Group M12: Extra relay control
#define BOTTOM_LIGHT_DISABLE 0 // M14 (Default: Must be zero)
#define BOTTOM_LIGHT_ENABLE  1 // M13 (NOTE: Uses planner condition bit flag)

// Modal Group M13: Extra relay control
#define ADC_ENABLE  1 // M20 (NOTE: Uses planner condition bit flag)
...
typedef struct {
  ...
  uint8_t feeder;          // {M15,M16,M17,M18,M19}
  uint8_t spindle;         // {M3,M4,M5}
  uint8_t top_light;  	   // {M11,M12}
  uint8_t bottom_light;    // {M13,M14}
} gc_modal_t;
